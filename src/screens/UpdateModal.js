          ...
          >
            ...
            >
              ...
              >
                {this.state.message
                  ? this.state.message
                  : "A new version is available for CBT Companion. Please update your app from App Store to continue."}
              </Text>
              <Button
                style={{ flex: 1, marginTop: 32 }}
                name="Update"
                onPress={() => {
                  const url = `itms-apps://itunes.apple.com/app/cbt-companion/id1445499245`;
